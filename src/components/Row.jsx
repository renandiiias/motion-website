...
function Row({ translateClass, direction }) {
    ...
    const items = [
        { text: "útil", image: img7 },
        { text: "intuitivo", image: img2 },     
        { text: "empático", image: img3 },     
        { text: "útil", image: img4 },     
        { text: "empático", image: img5 },
        { text: "intuitivo", image: img2 },
        { text: "útil", image: img4 },     
        { text: "empático", image: img5 },
        { text: "intuitivo", image: img2 },     
        { text: "empático", image: img6 },
        { text: "útil", image: img1 },      
        { text: "empático", image: img6 },
        { text: "empático", image: img5 },
        { text: "intuitivo", image: img2 },
        { text: "útil", image: img4 },
