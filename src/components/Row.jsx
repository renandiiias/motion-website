    ...
    >
        {items.map((item, index) => {
            return (
                <div 
                    key={index} 
                    className='elem flex items-center gap-4 sm:gap-8'
                >
                    <h1 
                        className='font-[SansitaBold] text-[4vh] sm:text-[8.4vh] 
                        leading-[4vh] sm:leading-[9vh]'
                    >
                        {item.text}
                    </h1>
                    <div className='imgdiv w-[3vh] h-[3vh] sm:w-[5vh] sm:h-[5vh]'>
                        <img 
                            className=''
                            src={item.image} 
                        />
