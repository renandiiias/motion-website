    ...
    >
        <div className="left sm:w-1/3 h-full flex flex-col sm:justify-between py-10 items-start " >
            ...
            <div className="heading">
                <h1 className="font-[SansitaReg] text-[5vh] leading-[6.5vh] sm:text-[8vh] py-5 sm:leading-[9vh]">Explore <br/> Nossos Cases</h1>
                <Button bgColor="bg-[#8B5CF6]" text="VEJA TODOS OS PROJETOS" />
            </div>
        </div>
        <div className=" right font-[SansitaReg] mt-10 sm:w-2/3 space-y-10 h-full sm:flex items-start justify-start sm:gap-20  ">
            ...
            <div   
                ...
                <button className="bg-[#8B5CF6] text-white px-4 rounded-full text-medium py-3 mb-10 mt-10 font-semibold">Liderança de Pensamento</button>
